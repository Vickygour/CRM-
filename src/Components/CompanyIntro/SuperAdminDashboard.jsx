        ...
        <div className="mx-auto max-w-[1800px] px-4 md:px-6 lg:px-8">
          <div className="flex h-14 items-center justify-between">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="hidden lg:flex items-center gap-2 rounded-lg border border-white/[0.06] bg-white/[0.02] px-4 py-1.5 text-sm text-white/40 transition-colors hover:border-white/10 hover:text-white/60"
            >
              <Search className="h-3.5 w-3.5" />
              <span>Search or command...</span>
              <kbd className="ml-auto flex h-5 items-center gap-0.5 rounded bg-white/[0.06] px-1.5 text-[10px] font-medium">
            ...
            <div className="flex items-center gap-2">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={handleRefresh}
                className="rounded-lg border border-white/[0.06] bg-white/[0.02] p-2 transition-colors hover:border-white/10"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="relative rounded-lg border border-white/[0.06] bg-white/[0.02] p-2 transition-colors hover:border-white/10"
              >
                <Bell className="h-4 w-4 text-white/60" />
                <span className="absolute right-1 top-1 h-1.5 w-1.5 rounded-full bg-blue-500"></span>
              </motion.button>

              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="flex items-center gap-2 rounded-lg bg-white px-3 py-1.5 text-xs font-medium text-black transition-all hover:bg-white/90"
              >
          ...
          {/* Time Range Tabs */}
          <div className="flex h-10 items-center gap-1 border-t border-white/[0.06]">
